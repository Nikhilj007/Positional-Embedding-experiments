"""
Training script for Original ViT (1D Learnable Positional Embedding) on CIFAR-100.

Usage:
    python original_vit/train.py [--epochs 200] [--batch_size 128] [--lr 1e-3]
"""
...
from original_vit.model import ViT, count_parameters
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Original ViT on CIFAR-100")
...
def main():
    ...
    print(f"\nOriginal ViT (1D Learned Positional Embedding)")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save({
                ...
                "val_acc": val_acc,
            }, os.path.join(args.save_dir, "original_vit_best.pth"))
    ...
    # Save metrics
    logger.save(os.path.join(args.save_dir, "original_metrics.json"))
