...
#SBATCH --output=logs/original_vit_%j.out
#SBATCH --error=logs/original_vit_%j.err

# ============================================================
# SLURM job script: Train Original ViT on CIFAR-100
# ============================================================
...
# Run training
echo "Starting Original ViT training..."
python3 original_vit/train.py \
    --epochs 200 \
    --batch_size 128 \
    --lr 1e-3 \
    --weight_decay 0.05 \
...
echo ""
echo "Original ViT training completed at $(date)"
